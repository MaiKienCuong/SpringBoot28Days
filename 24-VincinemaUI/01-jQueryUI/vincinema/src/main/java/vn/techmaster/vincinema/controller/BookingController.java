...
public class BookingController {
	...
	public String findEvent(@ModelAttribute("findEventRequest") FindEventRequest findEventRequest,
	...
	@GetMapping("/ticket")
	public String showBookingForm(@ModelAttribute BookingRequest bookingRequest, BindingResult bindingResult,
			Model model) {
		if (!bindingResult.hasErrors()) {
